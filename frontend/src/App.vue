  ...
  <div v-if="!isFirstRun" class="app-shell">
    ...
    <main class="main-content">
      ...
      <section v-else-if="notesStore.activeTab === 'list'" class="notes-view">
        ...
        <button v-if="notesStore.listHasMore" class="button button--quiet list-load-more" type="button" @click="notesStore.loadNotes({ tab: 'list', append: true })">Загрузить ещё</button>
      </section>
